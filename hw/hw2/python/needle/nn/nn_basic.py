...
class Linear(Module):
    def __init__(
        ...
        self.b=bias
        ### BEGIN YOUR SOLUTION
        self.weight=Parameter(init.kaiming_uniform(fan_in=in_features,fan_out=out_features))#in,out
        self.bias=Parameter(init.kaiming_uniform(out_features,1).transpose())#1,out
        ### END YOUR SOLUTION
...
class SoftmaxLoss(Module):
    def forward(self, logits: Tensor, y: Tensor):
        ...
        z_y=logits*init.one_hot(logits.shape[1],y)
